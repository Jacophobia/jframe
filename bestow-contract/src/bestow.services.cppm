...
// Lua Runtime (replaces IConfigSystem and IBlueprintFactory)
struct ILuaRuntimeService : kgr::abstract_service<ILuaRuntime> {};
...
template<> struct ServiceFor<ILuaRuntime> { using type = ILuaRuntimeService; };
