...
public:
    ...
    std::string serializeComponent(const BestowEngine& engine, Entity entity, const std::string& componentName) const;
};

ComponentRegistry& getComponentRegistry();

EntityInspector::EntityInspector(BestowEngine& engine) : engine_(engine) {}
