// bestow-graphics/src/bestow.graphics.impl.cppm
...
export module bestow.graphics.impl;

import std;
import bestow.graphics;
import bestow.types;
import bestow.assets;  // For IAssetSystem
import bestow.entity;  // For IEntitySystem and entity rendering
