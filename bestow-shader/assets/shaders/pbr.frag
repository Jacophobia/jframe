...
// PBR parameters
uniform float uMetallic;         // Metallic factor (default: 0.0)
uniform float uRoughness;        // Roughness factor (default: 0.5)
uniform float uAO;               // Ambient occlusion (default: 1.0)
uniform vec3 uF0;                // Base reflectivity (default: 0.04, 0.04, 0.04)
...
void main() {
    ...
    vec3 F0 = mix(uF0, albedo, uMetallic);
