# JFrame Technical Design

> **Last Updated:** 2025-11-26
> **Status:** Living Document
> **Purpose:** Comprehensive architecture and design reference for JFrame game framework
...
JFrame is a modern C++23 game framework built on interface-driven architecture, ECS (Entity Component System), and data-driven design. It emphasizes:
...
JFrame uses a hybrid approach combining:
...
JFrame uses C++23 modules with `import std;` for standard library access.

**Module naming convention:**

```
jframe.types          // Core types and aliases
jframe.entity         // Entity system interface
...
```cpp
// jframe-entity/src/jframe.entity.cppm (Interface)
module;
...
```cpp
// jframe-entity/src/jframe.entity.impl.cppm (Implementation Interface)
module;
...
```cpp
// jframe-entity/src/EntitySystem.cpp (Implementation)
...
import jframe.entity;       // Just entity system
import jframe.graphics;     // Just graphics system

#ifdef JFRAME_DEV_TOOLS
import jframe.dev;          // Dev tools (debug only)
#endif
```
...
TEST(EntitySystemTest, CreateEntity) {
    auto system = jframe::createEntitySystem();
...
```bash
# Format code
clang-format -i jframe-entity/src/*.cpp

# Static analysis
clang-tidy jframe-entity/src/*.cpp
```
