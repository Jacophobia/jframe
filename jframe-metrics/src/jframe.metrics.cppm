// jframe-metrics/src/jframe.metrics.cppm
// Comprehensive observability and profiling for JFrame
//
...
export module jframe.metrics;

import std;
import jframe.types;

export namespace jframe::metrics {
...
// Use the JFRAME_* macros in implementation files for zero-cost abstraction
...
// Usage in .cpp files:
//   JFRAME_ZONE_SCOPED;                    // Profile current scope
//   JFRAME_ZONE_NAMED("CustomName");       // Profile with custom name
//   JFRAME_FRAME_MARK;                     // Mark frame boundary
//   JFRAME_PLOT("EntityCount", count);     // Plot value over time
//   JFRAME_MESSAGE("Event occurred");      // Log message to timeline
...
inline std::string getMetricsSummary() {
    ...
    oss << "=== JFrame Metrics Summary (Frame " << collector.frameCount() << ") ===\n";
