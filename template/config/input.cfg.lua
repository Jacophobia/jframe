...
return {
    ...
    actions = {
        ...
        { action = "MenuUp",      phases = {"menu", "pause", "controls", "settings"},
          keys = {"Comma", "W", "Up"},       buttons = {"DPadUp"},
          axes = {"LeftY"}, deadzone = 0.5,  mode = "discrete" },
        { action = "MenuDown",    phases = {"menu", "pause", "controls", "settings"},
          keys = {"O", "S", "Down"},         buttons = {"DPadDown"},
          axes = {"LeftY"}, deadzone = 0.5,  mode = "discrete" },
        { action = "MenuLeft",    phases = {"menu", "pause", "controls", "settings"},
          keys = {"A", "Left"},              buttons = {"DPadLeft"},
          axes = {"LeftX"}, deadzone = 0.5,  mode = "discrete" },
        { action = "MenuRight",   phases = {"menu", "pause", "controls", "settings"},
          keys = {"E", "D", "Right"},        buttons = {"DPadRight"},
          axes = {"LeftX"}, deadzone = 0.5,  mode = "discrete" },
